	...
	return (
		<>
			...
			<div className='flex gap-2 flex-col mb-16'>
				<p className=' font-normal text-[12px] leading-5 text-[#383838]'>
			...
			<button
				className={`border-0 mt-10 text-white text-[16px] leading-5 font-medium mb-3 rounded-[23px] p-[8px] w-full h-[46px] transition-all ${buttonColor}`}
